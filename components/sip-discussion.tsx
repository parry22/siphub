...
export function SipDiscussion({ comments }: SipDiscussionProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {comments.length === 0 ? (
        <p className="text-muted-foreground py-4">No comments yet. Be the first to discuss this SIP!</p>
      ) : (
        <div className="space-y-6">
          {comments.map((comment) => (
            <div key={comment.id} className="border rounded-lg p-5 space-y-4 bg-card">
